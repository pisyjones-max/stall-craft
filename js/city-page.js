...
window.SC_CITIES = {
  ramenskoe: {
    ...
    nearby: ['novokharitonovo', 'zhukovskiy', 'bronnitsy', 'voskresensk'],
  },
  novokharitonovo: {
    id:         'novokharitonovo',
    city:       'Новохаритоново',
    cityPrep:   'в Новохаритоново',
    cityGen:    'Новохаритоново',
    cityDat:    'Новохаритоново',
    region:     'Московская область',
    regionShort:'МО',
    distance:   '40 км от МКАД',
    driveTime:  '45 минут',
    phone:      '+7 (933) 203-30-05',
    slug:       'garazhi-novokharitonovo',
    service:    'garazhi',
    serviceRu:  'Гаражи',
    lat:        '55.6423',
    lon:        '38.2699',
    variant:    1,
    photoOrder: [1, 2, 0, 3],
    nearby: ['ramenskoe', 'gzhel', 'bronnitsy', 'zhukovskiy'],
  },
  gzhel: {
    id:         'gzhel',
    city:       'Гжель',
    ...
    variant:    2,
    photoOrder: [3, 1, 2, 0],
    nearby: ['novokharitonovo', 'ramenskoe', 'voskresensk', 'bronnitsy'],
  },
  zhukovskiy: {
    id:         'zhukovskiy',
    city:       'Жуковский',
    ...
    variant:    1,
    photoOrder: [2, 0, 3, 1],
    nearby: ['ramenskoe', 'novokharitonovo', 'bronnitsy', 'voskresensk'],
  },
  bronnitsy: {
    id:         'bronnitsy',
    city:       'Бронницы',
    ...
    variant:    0,
    photoOrder: [1, 3, 0, 2],
    nearby: ['ramenskoe', 'zhukovskiy', 'voskresensk', 'novokharitonovo'],
  },
  voskresensk: {
    id:         'voskresensk',
    city:       'Воскресенск',
    ...
    variant:    1,
    photoOrder: [2, 1, 3, 0],
    nearby: ['gzhel', 'ramenskoe', 'bronnitsy', 'novokharitonovo'],
  },
};
...
window.SC_CityPage = {
  ...
  _setMeta(c, v) {
    ...
    this._setOrCreate('link[rel="canonical"]', 'link', {
      rel: 'canonical',
      href: `https://sk-craft.platforma-msk.ru/${c.slug}/`,
    });
  ...
  _renderSchema(c) {
    const schema = {
      ...
      '@type': 'LocalBusiness',
      '@id': `https://sk-craft.platforma-msk.ru/${c.slug}/`,
      'name': 'Сталь Крафт',
      'description': VARIANTS.metaDesc[c.variant](c),
      'url': `https://sk-craft.platforma-msk.ru/${c.slug}/`,
      'telephone': c.phone,
      'image': 'https://sk-craft.platforma-msk.ru/img/og-cover.webp',
      'priceRange': '₽₽',
